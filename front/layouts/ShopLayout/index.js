...
function ShopLayout({children}) {
  return (
    ...
    <Nav.Link style={{position:'absolute',left:830,top:3 }} href="#pricing"><AiOutlineSearch  size={25}/></Nav.Link>
            <Nav.Link style={{marginLeft:300}} href="#pricing"><AiOutlineUser  size={25}/></Nav.Link>
